...
namespace Eshop_HoangAnhHuy.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var producttype = _context.Products.Where(p => p.Id == id).FirstOrDefault().ProductTypeId;
            ViewData["RelatedProduct"] = _context.Products.Include(p => p.ProductType).Where(p => p.ProductTypeId == producttype && p.Id != id);
            return View(product);
        }
